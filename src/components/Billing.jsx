...
const Billing = () => {
  return (
    <div className='flex md:flex-row flex-1 flex-col mt-10'>
      ...
      <div className='md:w-[50%] md:ml-10 md:px-10 py-10 flex flex-col'>
        <h1 className={`${styles.heading2} py-4 px-6`}>Easily control your billing & invoicing.</h1>
        <p className={`${styles.paragraph} py-4 pl-6 md:w-[470px]`}>Elit enim sed massa etiam. Mauris eu adipiscing ultrices ametodio aenean neque. Fusce ipsum orci rhoncus aliporttitor integer platea placerat.</p>
